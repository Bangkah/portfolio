...
const socialLinks = [
  ...
  },
  {
    ...
    color: "#ffffff",
    gradient: "from-[#000000] via-[#111111] to-[#333333]",
  },
];
...
const SocialLinks = () => {
  ...
  const instagram = otherLinks.find((link) => link.name === "Instagram");
  const github = otherLinks.find((link) => link.name === "GitHub");
  const tiktok = otherLinks.find((link) => link.name === "TikTok");
    ...
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, github].filter(Boolean).map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
