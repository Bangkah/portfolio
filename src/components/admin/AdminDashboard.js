          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 24 }}>
            {projects.map(p => (
              <div key={p.id} style={{ background: "#222034", borderRadius: 10, padding: 16, color: "#fff", boxShadow: "0 2px 8px #0002", position: "relative" }}>
                <img src={p.imgPath} alt={p.title} loading="lazy" decoding="async" width={320} height={140} style={{ width: "100%", height: 140, objectFit: "cover", borderRadius: 8, marginBottom: 10, background: "#181028" }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 24 }}>
            {certificates.map((c, idx) => (
              <div key={c.id} style={{ background: "#222034", borderRadius: 10, padding: 12, textAlign: "center", boxShadow: "0 2px 8px #0002", position: "relative" }}>
                <img src={c.file} alt={`certificate-${idx}`} loading="lazy" decoding="async" width={320} height={180} style={{ width: "100%", height: 180, objectFit: "contain", borderRadius: 8, background: "#181028" }} />
