        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <br/><br/>
              Saya senang menciptakan solusi digital yang efisien, responsif, dan mudah dikembangkan. Dalam setiap proyek, saya selalu mengutamakan kerapian kode, kolaborasi tim, dan pemanfaatan tools profesional untuk menunjang produktivitas. Saya percaya bahwa pembelajaran dan adaptasi teknologi baru adalah kunci untuk terus berkembang di dunia IT. Saya terbuka untuk kolaborasi, diskusi, maupun peluang baru di bidang teknologi.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              >
                <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> View & Download CV
              </button>
              </Link>
